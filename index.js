...
console.log('tak 1c', finals2014[0] ['Home Team Goals']);
...
function getFinals(data) {
    ...
    // you can use filter here and stage 
    return allFinals;
 }
...
function getYears(data, getFinalsCB) {
  ...
  // use map
  // use a conditional if home team goals > away team goals then we want the home team name
}
...
function getWinners(data, getFinalsCB) {
    return getFinalsCB(data).map(item => item['Home Tea, Goals'] > item['Away Team Goals'] ?
